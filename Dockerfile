...
# Supporting tools
RUN apt-get -qqy install sudo wget telnet nano vim curl make git bzip2 zip unzip gettext-base locales cifs-utils software-properties-common
...
# PHP 5.6
RUN apt-get -qqy install php5.6 php5.6-cli php5.6-fpm php5.6-mysql php5.6-curl php5.6-soap php5.6-common php5.6-gd php5.6-mcrypt php5.6-tidy php5.6-mbstring
...
# PHP 7.0
RUN apt-get -qqy install php7.0 php7.0-cli php7.0-fpm php7.0-mysql php7.0-curl php7.0-soap php7.0-common php7.0-gd php7.0-mcrypt php7.0-tidy php7.0-mbstring

...
echo "Updating Legacy-LAP Dockerfile and README with latest supported PHP, PMA and Ubuntu LTS versions..."
...
if [ "$#" -gt 0 ]; then
    ...
    echo "Fetching available PHP versions from ondrej/php PPA..."
...
TEMPLATE_DOCKERFILE="templates/legacy-lap/Dockerfile"
OUTPUT_DOCKERFILE="../legacy/legacy-lap/Dockerfile"
TEMPLATE_README="templates/legacy-lap/README.md"
OUTPUT_README="../legacy/legacy-lap/README.md"
